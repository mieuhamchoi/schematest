...
export default function Header() {
  return (
    <nav className="navbar max-h-[60px] bg-white border-gray-200 dark:bg-gray-900 text-base">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div className='flex items-center'>
                ...
                <Link href="/" className="flex items-center">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">P2team</span>
                </Link>
                {/* Location */}
                <div className="flex items-center mt-1.5 mx-5">
                    <img  src="/img/location.svg" className='w-[16px] h-[16px]'/>
                    <span className='font-semibold text-sm mx-2'>72 Phạm Thị Tánh, P4, Q8, TP HCM</span>
                    <span className="font-semibold text-blue-500 cursor-pointer">Sửa</span>
                </div>
            </div>

            <Link href='/about'>
                <button type="button" className="py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">About</button>
            </Link>
            <div className='flex items-center'>
                {/* Cart */}
                <div className='flex items-center mx-5 cursor-pointer'>
                    <img src="/img/shopping_cart.svg" className='w-[40px] h-[30px]'/>
                    <span className='mx-2 font-semibold text-sm'>Bạn có (1) sản phẩm trong giỏ hàng</span>
                </div>
                {/* Select Language */}
